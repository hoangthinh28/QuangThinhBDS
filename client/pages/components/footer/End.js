...
export default function End() {
  return (
    <div className="max-width w-full pr-4 pl-4 mr-auto ml-auto pt-14">
      <div class="flex flex-wrap -mr-4 -ml-4 items-center">
        <div class="col-lg-4">
          <ul class="pl-0 list-none">
            <li>
              <a href="#" class="flex items-center pl-48">
                <span class="inline-block w-16 h-16 bg-white relative mr-5 rounded-full">
                  <span class="flex items-center justify-center rounded-full bg-white w-16 h-16 top-14 left-14 text-amber-600 text-3xl">
                    <HotelRoundedIcon fontSize="large" />
                  </span>
                </span>
                <span class="text-black text-base line-height">
            ...
            <li>
              <a href="#" class="flex items-center pl-48 pt-8">
                <span class="inline-block w-16 h-16 bg-white relative mr-5 rounded-full">
                  <span class="flex items-center justify-center rounded-full bg-white w-16 h-16 top-14 left-14 text-amber-600 text-3xl">
        ...
        <div class="col-lg-4 mb-4 mb-lg-0 pl-10 h-full">
          <img
            src="https://preview.colorlib.com/theme/homey/images/ximg_portrait_1.jpg.pagespeed.ic.e8w00GWuiQ.webp"
            alt="Image"
            class=" w-80 h-full max-h-screen rounded-t-lg"
          />
        </div>
        <div class="flex col-lg-4">
          <h3 class="block text-base max-h-screen mb-4 text-orange-500 pb-72 pl-7">
            Why Us
          </h3>
          <h2 class="mb-4 -ml-10 absolute text-4xl text-black font-bold pt-12 pr-28">
